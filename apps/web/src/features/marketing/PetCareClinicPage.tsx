...
export function PetCareClinicPage() {
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <nav className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          <div className="flex items-center gap-6">
            ...
            <span className="text-xs font-bold text-slate-900">VETERINARY & PET OS</span>
          </div>
          <a
      ...
      <section className="relative overflow-hidden pt-16 pb-20 text-center">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-6 text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl">
            Unified Practice Management for Pet Clinics & Grooming Parlours
          </h1>
          <p className="mx-auto mt-6 max-w-3xl text-lg text-slate-600 leading-relaxed">
            Handle clinical records, grooming station bookings, weight-adjusted medications, and pet food retail on one seamless cloud platform.
          </p>
          ...
          <div className="mx-auto mt-12 flex max-w-4xl flex-wrap items-center justify-center gap-3 rounded-2xl border border-slate-200/80 bg-white/80 px-6 py-3 text-xs font-medium text-slate-600 shadow-xs backdrop-blur-sm sm:text-[13px]">
            <span>Breed Dosage & Veterinary Billing POS</span>
            <span className="text-slate-300">✦</span>
            <span>Vaccination Schedule & Pet ERP</span>
            <span className="text-slate-300">✦</span>
            <span>Online Food & Grooming Storefront</span>
            <span className="text-slate-300">✦</span>
            <span>Local Pet Parent WhatsApp Campaigns</span>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-slate-200 bg-slate-50/70 py-12">
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-8 px-4 text-center sm:grid-cols-4 sm:px-6 lg:px-8">
            ...
            <div>
              <div className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">98%</div>
              <div className="mt-1 text-xs font-semibold text-slate-500">Vaccination Due Re-Booking Rate</div>
            </div>
          
            <div>
              <div className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">0</div>
              <div className="mt-1 text-xs font-semibold text-slate-500">Grooming Station Double-Booking Conflicts</div>
            </div>
          
            <div>
              <div className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">100%</div>
              <div className="mt-1 text-xs font-semibold text-slate-500">Weight-Based Prescription Accuracy</div>
            </div>
          
            <div>
              <div className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">4.9/5</div>
              <div className="mt-1 text-xs font-semibold text-slate-500">Pet Parent Satisfaction Score</div>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-slate-200 p-8 shadow-xs transition hover:border-slate-300">
                <h3 className="text-lg font-bold text-slate-900">Pet Patient Health Passports</h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-600">Record breed, weight history, allergy notes, deworming cycles, and vaccination records accessible in seconds.</p>
              </div>
            
              <div className="rounded-2xl border border-slate-200 p-8 shadow-xs transition hover:border-slate-300">
                <h3 className="text-lg font-bold text-slate-900">Automated Vaccine Recalls</h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-600">Proactively notify pet parents via WhatsApp when booster shots or annual rabies vaccinations are due.</p>
              </div>
            
              <div className="rounded-2xl border border-slate-200 p-8 shadow-xs transition hover:border-slate-300">
                <h3 className="text-lg font-bold text-slate-900">Grooming Desk Booking Board</h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-600">Visual chair schedules for bath, de-shedding, haircut, and flea treatments with designated groomer assignments.</p>
              </div>
            
              <div className="rounded-2xl border border-slate-200 p-8 shadow-xs transition hover:border-slate-300">
                <h3 className="text-lg font-bold text-slate-900">Pet Food & Accessory POS</h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-600">Scan barcode tags on premium pet kibble, leashes, toys, and veterinary prescription diets with bulk discounts.</p>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex justify-center">
          <div className="max-w-[1180px] w-full min-h-[500px] rounded-[28px] overflow-hidden grid grid-cols-1 lg:grid-cols-12 items-center gap-10 p-8 md:p-14 bg-white border border-slate-200 shadow-sm relative dark:bg-slate-900 dark:border-slate-800">
            ...
            <div
              ...
              style={{ backgroundImage: `url('${'https://images.unsplash.com/photo-1516734212186-a967f81ad0d7?auto=format&fit=crop&w=1600&q=80'}')` }}
            />
            ...
            <div className="lg:col-span-7 z-10 flex flex-col justify-center text-left">
              <span className="inline-flex items-center gap-2 rounded-full border border-orange-200 bg-orange-50/90 px-3.5 py-1 text-[11px] font-bold tracking-wider text-orange-800 uppercase w-max mb-4 dark:border-orange-900/40 dark:bg-orange-950/40 dark:text-orange-300">
                VETERINARY & PET CARE OS
              </span>
              <h2 className="text-3xl sm:text-4xl lg:text-[40px] font-extrabold text-slate-900 tracking-tight leading-[1.18] dark:text-white">
                Run Grooming Chairs, Vaccine Alerts, and Pet Retail on <span className="text-orange-600">One Unified System</span>
              </h2>
              <p className="mt-4 text-base sm:text-lg text-slate-600 leading-relaxed max-w-xl dark:text-slate-300">
                Breed-specific medical history logs, automated vaccine reminder WhatsApps, weight-based dosage POS, and grooming appointment slots.
              </p>
