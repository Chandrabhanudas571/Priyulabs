...
export function AutomobileWorkshopsPage() {
  return (
      ...
      <nav className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          <div className="flex items-center gap-6">
            ...
            <span className="text-xs font-bold text-slate-900">AUTOMOTIVE & WORKSHOP OS</span>
          </div>
          <a
            href="https://wa.me/917873844050?text=Hi%20Priyulabs%20Team%2C%20I%20want%20to%20see%20a%20demo"
            target="_blank"
      ...
      <section className="relative overflow-hidden pt-16 pb-20 text-center">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-6 text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl">
            High-Efficiency Workshop, Bodyshop & Detailing Garage Platform
          </h1>
          <p className="mx-auto mt-6 max-w-3xl text-lg text-slate-600 leading-relaxed">
            Digitize vehicle intake inspections, track spare parts shrinkage, allocate mechanic hours, and send transparent digital estimates for customer approval.
          </p>
          ...
          <div className="mx-auto mt-12 flex max-w-4xl flex-wrap items-center justify-center gap-3 rounded-2xl border border-slate-200/80 bg-white/80 px-6 py-3 text-xs font-medium text-slate-600 shadow-xs backdrop-blur-sm sm:text-[13px]">
            <span>Vehicle In-Gate Job-Card POS</span>
            <span className="text-slate-300">✦</span>
            <span>Mechanic Bay & Parts Inventory ERP</span>
            <span className="text-slate-300">✦</span>
            <span>Digital Inspection & Estimate Approvals</span>
            <span className="text-slate-300">✦</span>
            <span>Periodic Service & Oil Change Reminder Ads</span>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-slate-200 bg-slate-50/70 py-12">
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-8 px-4 text-center sm:grid-cols-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <div className="mt-1 text-xs font-semibold text-slate-500">Pre-Existing Dent & Scratch Photo Documentation</div>
            </div>
          
            <div>
              <div className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">0</div>
              <div className="mt-1 text-xs font-semibold text-slate-500">Unaccounted Spare Parts or Oil Leakage</div>
            </div>
          
            <div>
              <div className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">35%</div>
              <div className="mt-1 text-xs font-semibold text-slate-500">Faster Customer Digital Estimate Approvals</div>
            </div>
          
            <div>
              <div className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">4.9/5</div>
              <div className="mt-1 text-xs font-semibold text-slate-500">Vehicle Owner Transparency Score</div>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-slate-200 p-8 shadow-xs transition hover:border-slate-300">
                <h3 className="text-lg font-bold text-slate-900">Vehicle Plate & Job-Card Ingestion</h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-600">Scan number plate or enter registration to instantly pull complete vehicle history, odometer reading, and fuel level.</p>
              </div>
            
              <div className="rounded-2xl border border-slate-200 p-8 shadow-xs transition hover:border-slate-300">
                <h3 className="text-lg font-bold text-slate-900">Digital Inspection & Scratch Map</h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-600">Document pre-existing dents, warning lights, and scratches on a 360-degree vehicle diagram signed digitally by owner.</p>
              </div>
            
              <div className="rounded-2xl border border-slate-200 p-8 shadow-xs transition hover:border-slate-300">
                <h3 className="text-lg font-bold text-slate-900">Spare Parts & Lubricant Depletion</h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-600">Barcode scan engine oil, brake pads, and filters directly to the job card, preventing technician shrinkage.</p>
              </div>
            
              <div className="rounded-2xl border border-slate-200 p-8 shadow-xs transition hover:border-slate-300">
                <h3 className="text-lg font-bold text-slate-900">WhatsApp Estimate & Approval Desk</h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-600">Send itemized parts + labor cost estimates with attached inspection photos for 1-click WhatsApp customer approval.</p>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex justify-center">
          <div className="max-w-[1180px] w-full min-h-[500px] rounded-[28px] overflow-hidden grid grid-cols-1 lg:grid-cols-12 items-center gap-10 p-8 md:p-14 bg-white border border-slate-200 shadow-sm relative dark:bg-slate-900 dark:border-slate-800">
            ...
            <div
              ...
              style={{ backgroundImage: `url('${'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?auto=format&fit=crop&w=1600&q=80'}')` }}
            />
            ...
            <div className="lg:col-span-7 z-10 flex flex-col justify-center text-left">
              <span className="inline-flex items-center gap-2 rounded-full border border-orange-200 bg-orange-50/90 px-3.5 py-1 text-[11px] font-bold tracking-wider text-orange-800 uppercase w-max mb-4 dark:border-orange-900/40 dark:bg-orange-950/40 dark:text-orange-300">
                AUTO WORKSHOP & DETAILING OS
              </span>
              <h2 className="text-3xl sm:text-4xl lg:text-[40px] font-extrabold text-slate-900 tracking-tight leading-[1.18] dark:text-white">
                From Vehicle In-Gate to Final Invoice with <span className="text-orange-600">Complete Transparency</span>
              </h2>
              <p className="mt-4 text-base sm:text-lg text-slate-600 leading-relaxed max-w-xl dark:text-slate-300">
                Registration number job cards, mechanic labor allocation, spare parts barcode depletion, and digital photo inspection approvals.
              </p>
