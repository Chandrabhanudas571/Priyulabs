        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          ...
          >
            ...
            <a href="#matrix-features"
             ...
             onClick={(e) => { e.preventDefault(); (document.querySelector('#matrix-features') || document.getElementById('matrix-features') || document.getElementById('pillars') || document.querySelector('.clean-pillars-sec, .pillars-sec, .triptych-sec, .pillars-grid'))?.scrollIntoView({ behavior: 'smooth' }); }}>
