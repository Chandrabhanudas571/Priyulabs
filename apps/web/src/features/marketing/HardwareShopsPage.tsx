...
export function HardwareShopsPage() {
  return (
      ...
      <nav className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          <div className="flex items-center gap-6">
            ...
            <span className="text-xs font-bold text-slate-900">RETAIL & HARDWARE OS</span>
          </div>
          <a
      ...
      <section className="relative overflow-hidden pt-16 pb-20 text-center">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-6 text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl">
            Engineered for Hardware, Plumbing & Paint Merchants
          </h1>
          <p className="mx-auto mt-6 max-w-3xl text-lg text-slate-600 leading-relaxed">
            Eliminate manual math on cut cables, steel weight conversions, and unpaid contractor tabs. Priyulabs brings automated ledger billing to modern hardware stores.
          </p>
          ...
          <div className="mx-auto mt-12 flex max-w-4xl flex-wrap items-center justify-center gap-3 rounded-2xl border border-slate-200/80 bg-white/80 px-6 py-3 text-xs font-medium text-slate-600 shadow-xs backdrop-blur-sm sm:text-[13px]">
            <span>Multi-Unit Dimension Billing POS</span>
            <span className="text-slate-300">✦</span>
            <span>Contractor Credit & Ledger ERP</span>
            <span className="text-slate-300">✦</span>
            <span>Digital B2B Supply Catalog</span>
            <span className="text-slate-300">✦</span>
            <span>Local Builder Contractor Ad Boosters</span>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-slate-200 bg-slate-50/70 py-12">
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-8 px-4 text-center sm:grid-cols-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <div className="mt-1 text-xs font-semibold text-slate-500">Unit Conversion Accuracy (Meters, kg, bundles)</div>
            </div>
          
            <div>
              <div className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">0</div>
              <div className="mt-1 text-xs font-semibold text-slate-500">Unrecorded Contractor Tabs or Leaks</div>
            </div>
          
            <div>
              <div className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">1.4s</div>
              <div className="mt-1 text-xs font-semibold text-slate-500">Fast Barcode & Split-Roll Checkout</div>
            </div>
          
            <div>
              <div className="text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">4.9/5</div>
              <div className="mt-1 text-xs font-semibold text-slate-500">Merchant Operational Trust Score</div>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-slate-200 p-8 shadow-xs transition hover:border-slate-300">
                <h3 className="text-lg font-bold text-slate-900">Dual-Unit Dimension Billing</h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-600">Bill pipes in meters or bundles, cable in coils or feet, and structural steel in kilograms without manual calculation errors.</p>
              </div>
            
              <div className="rounded-2xl border border-slate-200 p-8 shadow-xs transition hover:border-slate-300">
                <h3 className="text-lg font-bold text-slate-900">Contractor Credit Khatas</h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-600">Set credit limits for trusted plumbers, electricians, and contractors with automated WhatsApp payment reminder links.</p>
              </div>
            
              <div className="rounded-2xl border border-slate-200 p-8 shadow-xs transition hover:border-slate-300">
                <h3 className="text-lg font-bold text-slate-900">Paint Tinting & Base Matching</h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-600">Track paint bases and colorant dispensers accurately, linking custom mixes to specific customer wall projects.</p>
              </div>
            
              <div className="rounded-2xl border border-slate-200 p-8 shadow-xs transition hover:border-slate-300">
                <h3 className="text-lg font-bold text-slate-900">Multi-Rate GST Invoice Filing</h3>
                <p className="mt-2 text-sm leading-relaxed text-slate-600">Auto-categorize 5%, 12%, 18%, and 28% GST hardware goods on a single unified invoice with 1-click GSTR-1 summaries.</p>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex justify-center">
          <div className="max-w-[1180px] w-full min-h-[500px] rounded-[28px] overflow-hidden grid grid-cols-1 lg:grid-cols-12 items-center gap-10 p-8 md:p-14 bg-white border border-slate-200 shadow-sm relative dark:bg-slate-900 dark:border-slate-800">
            ...
            <div
              ...
              style={{ backgroundImage: `url('${'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=1600&q=80'}')` }}
            />
            ...
            <div className="lg:col-span-7 z-10 flex flex-col justify-center text-left">
              <span className="inline-flex items-center gap-2 rounded-full border border-orange-200 bg-orange-50/90 px-3.5 py-1 text-[11px] font-bold tracking-wider text-orange-800 uppercase w-max mb-4 dark:border-orange-900/40 dark:bg-orange-950/40 dark:text-orange-300">
                HARDWARE, PLUMBING & ELECTRICAL OS
              </span>
              <h2 className="text-3xl sm:text-4xl lg:text-[40px] font-extrabold text-slate-900 tracking-tight leading-[1.18] dark:text-white">
                Track Split Units and Contractor Credit with <span className="text-orange-600">Zero Ledger Leaks</span>
              </h2>
              <p className="mt-4 text-base sm:text-lg text-slate-600 leading-relaxed max-w-xl dark:text-slate-300">
                Dual-unit conversion billing (meters/bundles/kg), contractor running accounts, batch paint tinting, and GST multi-rate invoicing.
              </p>
